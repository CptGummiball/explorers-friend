    ...
    private static void registerTree(CommandDispatcher<CommandSourceStack> dispatcher,
        ...
        dispatcher.register(Commands.literal("efmap")
                ...
                .then(Commands.literal("pause")
                        .requires(source -> Perms.atLeast(source, 2)).executes(MapCommands::pause))
                .then(Commands.literal("resume")
                        .requires(source -> Perms.atLeast(source, 2)).executes(MapCommands::resume))
                ...
                .then(Commands.literal("reload")
                        .requires(source -> Perms.atLeast(source, 2)).executes(MapCommands::reload))
                ...
                .then(Commands.literal("cache")
                        ...
                        .then(Commands.literal("prune")
                                .requires(source -> Perms.atLeast(source, 3))
                                .executes(context -> {
