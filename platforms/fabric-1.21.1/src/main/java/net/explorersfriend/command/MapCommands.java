    ...
    private static void registerTree(CommandDispatcher<ServerCommandSource> dispatcher,
        ...
        dispatcher.register(CommandManager.literal("efmap")
                ...
                .then(CommandManager.literal("pause")
                        .requires(source -> source.hasPermissionLevel(2)).executes(MapCommands::pause))
                .then(CommandManager.literal("resume")
                        .requires(source -> source.hasPermissionLevel(2)).executes(MapCommands::resume))
                ...
                .then(CommandManager.literal("reload")
                        .requires(source -> source.hasPermissionLevel(2)).executes(MapCommands::reload))
