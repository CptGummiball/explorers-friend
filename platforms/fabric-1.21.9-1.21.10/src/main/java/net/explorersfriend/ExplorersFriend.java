...
public final class ExplorersFriend implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        net.explorersfriend.platform.PlatformInfo.set(new net.explorersfriend.platform.PlatformInfo(
                quilt ? "quilt" : "fabric", mcVersion, "fabric-1.21.9-1.21.10", net.fabricmc.loader.api.FabricLoader.getInstance()
        ...
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerChunkEvents.CHUNK_LOAD.register(
                (world, chunk) -> MapService.ifPresent(service -> service.onChunkLoad(world, chunk)));
