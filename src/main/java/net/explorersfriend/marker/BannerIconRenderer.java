        ...
        try {
            ...
            for (int i = 1; i < parts.length; i++) {
                ...
                try {
                    ...
                    ExplorersFriend.LOGGER.debug("[ExplorersFriend/Banners] Pattern '{}' unavailable: {}",
        ...
        synchronized (this) {
            if (assets == null && vanillaJar != null) {
                try {
                    ...
                    ExplorersFriend.LOGGER.warn("[ExplorersFriend/Banners] Vanilla assets unavailable ({}); "
