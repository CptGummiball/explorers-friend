...
public final class FtbChunksClaimProvider implements ClaimProvider {
    ...
    @Override
    public List<RawArea> copyRawClaims(MinecraftServer server) {
    ...
    private static String ownerName(MinecraftServer server, UUID owner, String fallback) {
        ...
        return server.getUserCache() == null ? fallback
    ...
    @Override
    public void subscribe(MinecraftServer server, Runnable onChange) {
